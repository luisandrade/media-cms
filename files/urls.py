...
urlpatterns = [
    ...
    re_path(
        r"^api/v1/media/(?P<friendly_token>[\w\-_]*)/trim_video$",
        views.trim_video,
    ),
    ...
    re_path(r"^api/v1/manage_wowza/applications/(?P<app_id>\d+)/recording$", wowza_views.WowzaApplicationRecordingView.as_view()),
