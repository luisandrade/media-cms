      ...
      <nav ref="tabsNav" className="profile-nav items-list-outer list-inline list-slider">
        <div className="profile-nav-inner items-list-outer">
          ...
          <ul className="items-list-wrap" ref="itemsListWrap">
            ...
            <InlineTab
              id="live"
              isActive={'live' === this.props.type}
              label={translateString('Live')}
              link={LinksContext._currentValue.profile.live}
            />
            <InlineTab
              id="recorded"
              isActive={'recorded' === this.props.type}
              label={translateString('Grabaciones')}
              link={LinksContext._currentValue.profile.recorded}
            />
