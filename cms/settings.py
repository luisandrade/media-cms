...
# Optional CSS colors for the main navigation chrome. Leave empty to use theme defaults.
TOPBAR_BACKGROUND_COLOR = os.getenv("TOPBAR_BACKGROUND_COLOR", "")
SIDEBAR_BACKGROUND_COLOR = os.getenv("SIDEBAR_BACKGROUND_COLOR", "#1a1d29")
BODY_BACKGROUND_COLOR = os.getenv("BODY_BACKGROUND_COLOR", "")
BUTTON_BACKGROUND_COLOR = os.getenv("BUTTON_BACKGROUND_COLOR", "#e50914")
BUTTON_BACKGROUND_HOVER_COLOR = os.getenv("BUTTON_BACKGROUND_HOVER_COLOR", "")
...
WOWZA_SECURE_TOKEN_HASH_ALGORITHM = os.getenv("WOWZA_SECURE_TOKEN_HASH_ALGORITHM", "SHA-256")
...
WOWZA_STREAMING_FILE_DIRECTORY = os.getenv("WOWZA_STREAMING_FILE_DIRECTORY", "/mediavms/rodeovms/live_record")
WOWZA_MAX_APPLICATIONS = int(os.getenv("WOWZA_MAX_APPLICATIONS", "10"))
...
WOWZA_RECORD_SEGMENT_DURATION_SECONDS = int(os.getenv("WOWZA_RECORD_SEGMENT_DURATION_SECONDS", "900"))
WOWZA_PUBLISH_AUTH_METHOD = os.getenv("WOWZA_PUBLISH_AUTH_METHOD", "digest")
WOWZA_PUBLISH_PASSWORD_FILE = os.getenv("WOWZA_PUBLISH_PASSWORD_FILE", "")
WOWZA_PUSH_PUBLISH_ENTRY_NAME = os.getenv("WOWZA_PUSH_PUBLISH_ENTRY_NAME", "live")
WOWZA_PUSH_PUBLISH_PROFILE = os.getenv("WOWZA_PUSH_PUBLISH_PROFILE", "rtmp")
WOWZA_PUSH_PUBLISH_APPLICATION = os.getenv("WOWZA_PUSH_PUBLISH_APPLICATION", "miradio2restream")
WOWZA_PUSH_PUBLISH_DESTINATION_NAME = os.getenv("WOWZA_PUSH_PUBLISH_DESTINATION_NAME", "wowzastreamingengine")
WOWZA_PUSH_PUBLISH_HOST = os.getenv("WOWZA_PUSH_PUBLISH_HOST", WOWZA_HOST_DEFAULT)
WOWZA_PUSH_PUBLISH_STREAM_NAME = os.getenv("WOWZA_PUSH_PUBLISH_STREAM_NAME", "live")
WOWZA_RECORD_STREAM_NAME = os.getenv("WOWZA_RECORD_STREAM_NAME", WOWZA_PUSH_PUBLISH_STREAM_NAME)
...
FLOW_SUBSCRIPTION_PRICE_CLP = int(os.getenv("FLOW_SUBSCRIPTION_PRICE_CLP", "5000"))
...
FLOW_SUBSCRIPTION_ACCESS_SYNC_SECONDS = int(os.getenv("FLOW_SUBSCRIPTION_ACCESS_SYNC_SECONDS", "3600"))
